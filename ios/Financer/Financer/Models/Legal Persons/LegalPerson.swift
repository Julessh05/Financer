...
internal class LegalPerson {
    ...
    /// is a Company
    internal enum CompanyRelation : Relation {
    ...
    /// a Person
    internal enum PersonRelation : Relation {
    ...
    internal enum OrganizationRelation : Relation {
    ...
    internal init(name : String, relation : Relation) {
        self.name = name
