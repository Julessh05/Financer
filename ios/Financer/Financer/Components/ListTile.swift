...
//  Financer
//
//  Created by Julian Schumacher as LegalPersonListTile.swift on 26.11.22.
//  Renamed by Julian Schumacher to ListTile.swift on 03.12.22.
//
...
internal struct ListTile: View {
    ...
    internal init(person: LegalPerson, _ callback : @escaping () -> ()) {
        ...
        self.finance = Finance.anonymousFinance
    ...
    internal init(finance : Finance, _ callback : @escaping () -> ()) {
        ...
        self.callback = callback
        self.person = LegalPerson.anonymousPerson
